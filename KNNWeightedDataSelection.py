...
for num in dataIterations:
    ...
    kRange = range(1, 16) # Used to test K=2 -> k=15
    # kRange = range(1, 31) # Used to test K=2 -> k=30
...
# f = open('./DataSetWeiKNN/bestWeiDataStats.txt', 'w')
...
# f = open('./DataSetWeiKNN/bestUnwDataStats.txt', 'w')
# f.write("Best K-Value = %i\n" % bestKVal)
...
xUnwDataTrain = './DataSetWeiKNN/DataTrainingXKNNUnweighted'
yUnwDataTrain = './DataSetWeiKNN/DataTrainingYKNNUnweighted'
xUnwDataVal = './DataSetWeiKNN/DataValidationXKNNUnweighted'
yUnwDataVal = './DataSetWeiKNN/DataValidationYKNNUnweighted'
xUnwDataTest = './DataSetWeiKNN/DataTestXKNNUnweighted'
yUnwDataTest = './DataSetWeiKNN/DataTestYKNNUnweighted'
bestUnwDataStats = './DataSetWeiKNN/BestUnwDataSetStats'
bestWeightDataStats = './DataSetWeiKNN/BestWeiDataSetStats'
bestTotalXDataset = './DataSetWeiKNN/BestTotalXDataset'
...
# np.save(bestTotalXDataset, bestXSet)
# np.save('./DataSetWeiKNN/BestKValue', bestKVal)
...
print("Wei Test Accuracy = ", wei_testAcc)
print("Wei Test F1 Score = ", wei_testF1)
print("Unw Test Accuracy = ", testAcc)
print("Unw Test F1 Score = ", testF1)
...
plt.ylabel("Accuracy of Wei KNN Model")
plt.xticks(fontsize=16)
plt.yticks(fontsize=16)
plt.legend()
# plt.savefig("./DataSetWeiKNN/KNNAccF1UnwStrat.pdf", dpi=400, bbox_inches='tight', pad_inches=0.05)
plt.show()
plt.clf()
plt.close()
...
# Create a scatter plot of all galaxies in the total data set, showing masers and non masers as unique shapes/colors
maserL12 = []
maserLobs = []
nonMaserL12 = []
nonMaserLobs = []
...
plt.yticks(fontsize=16)
plt.legend()
# plt.savefig('./DataSetWeiKNN/AllDataScatterPlot.pdf', dpi=400, bbox_inches='tight', pad_inches=0.05)
plt.show()
plt.clf()
plt.close()
########################

######################## Plot the Heat Map of Maser Classification Probability Based on Unw KNN ########################
...
modelUnw = KNeighborsClassifier(n_neighbors=bestKVal, metric='euclidean')
...
plt.yticks(fontsize=16)
# save as a PDF
# plt.savefig('./DataSetWeiKNN/WeiKNNDatasetUnwHeatMap.pdf', dpi=400, bbox_inches='tight', pad_inches=0.05)
plt.show()
plt.clf()
plt.close()
########################
...
modelWei = KNeighborsClassifier(n_neighbors=bestKVal, metric='euclidean', weights='distance')
...
plt.yticks(fontsize=16)
# Save as a PDF
# plt.savefig('./DataSetWeiKNN/WeiKNNDatasetWeiHeatMap.pdf', dpi=400, bbox_inches='tight', pad_inches=0.05)
plt.show()
plt.clf()
plt.close()
########################
